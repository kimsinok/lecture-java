        ...
        <Row className='my-5'>
            <Col className='p-5'>
                <h3 className='text-center my-5'>{id}번 게시글 수정</h3>                
                    <Form>
                    <h4>제목</h4>
                    <Form.Control  className='my-3' name='title'  placeholder={article.title} onChange={handleChangeForm}/>
                    <h4>작성자</h4>
                    <Form.Control  className='my-3' name='writer' placeholder={article.writer} onChange={handleChangeForm} />
                    <h4>내용</h4>
                    <Form.Control as='textarea' rows={10} className='my-3' name='contents' placeholder={article.contents} onChange={handleChangeForm} />
