...
const Register = () => {
    ...
    console.log('nameRef : ', nameRef); // {current: input}
    console.log('birthRef : ', birthRef); // {current: input}
    console.log('countryRef : ', countryRef); // {current: select}
    console.log('bioRef : ', bioRef); // {current: textarea}
